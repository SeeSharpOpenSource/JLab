...
{
    public class JYUSB61902AITaskImpl : AITask
    {
        public JYUSB61902AITask AITask { get; private set; }

        public JYUSB61902AITaskImpl(int boardId)
        {
            AITask = new JYUSB61902AITask(boardId);
