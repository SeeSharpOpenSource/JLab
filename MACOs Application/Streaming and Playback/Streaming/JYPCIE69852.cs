...
{
    class JYPCIE69852 : StreamingTask
    {
        private readonly Type streamRawDataType = typeof(short);
        private JYPCIE69852AITask aitask;
        ...
        public JYPCIE69852(int boardNum)
        {
            aitask = new JYPCIE69852AITask(boardNum);
            NumOfChannels = 2;
        }
        ...
        public override void Record(int chnID, double sampleRate, double recordLength, double rangelow = -10, double rangeHigh = 10)
        {
            ...
            aitask.AddChannel(chnID, rangelow, rangeHigh, (AICoupling)Enum.Parse(typeof(AICoupling), Coupling.ToString()),
