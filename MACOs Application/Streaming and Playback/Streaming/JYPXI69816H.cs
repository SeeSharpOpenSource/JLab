...
{
    class JYPXI69816H : StreamingTask
    {
        private readonly Type streamRawDataType = typeof(ushort);
        private JYPXI69816HAITask aitask;
        ...
        public JYPXI69816H(int boardNum)
        {
            aitask = new JYPXI69816HAITask(boardNum);
            NumOfChannels = 4;
        }
        ...
        public override void Record(int chnID, double sampleRate, double recordLength, double rangelow = -5, double rangeHigh = 5)
        {
        ...
        /// <param name="rangelow">通道量程下限</param>
        /// <param name="rangeHigh">通道量程上限</param>
        public override void Record(int[] chnsID, double sampleRate, double recordLength, double rangelow = -5, double rangeHigh = 5)
        {
