...
{
    class JYPCI69846D : StreamingTask
    {
        private readonly Type streamRawDataType = typeof(ushort);
        private JYPCI69846DAITask aitask;
        ...
        public JYPCI69846D(int boardNum)
        {
            aitask = new JYPCI69846DAITask(boardNum);
            NumOfChannels = 4;
        }
        ...
        public override void Record(int chnID, double sampleRate, double recordLength, double rangelow = -1, double rangeHigh = 1)
        {
        ...
        /// <param name="rangelow">通道量程下限</param>
        /// <param name="rangeHigh">通道量程上限</param>
        public override void Record(int[] chnsID, double sampleRate, double recordLength, double rangelow = -1, double rangeHigh = 1)
        {
