...
{
    class JYPXIe69852 : AnalogInputDevices, IDigitizer
    {
        #region Private Fields
        private JYPXIe69852AITask aiTask;
        ...
        public JYPXIe69852(int boardNum)
        {
            aiTask = new JYPXIe69852AITask(boardNum);
            DigitizerInfo info = new DigitizerInfo()
            {
                MaxChannels = 2,
                MaxSampleRate = 200000000,
                Ranges = new string[] { "0.2", "2", "10" },
        ...
        public override void ConfigTrigger(object param)
        {
            ...
            switch (aiTask.Trigger.Type)
            {
                ...
                case AITriggerType.Analog:
                    ...
                    aiTask.Trigger.Mode = trgParam.TriggerMode;
                    aiTask.Trigger.Delay = trgParam.TriggerDelay;
                    aiTask.Trigger.Analog.TriggerLevel = trgParam.TriggerAnalogLevel;
                    aiTask.Trigger.PreTriggerSamples = trgParam.PreTriggerSamples;
        ...
        {
            aiTask.Start();
            if (data.GetLength(0) != aiTask.SamplesToAcquire || data.GetLength(1) != aiTask.Channels.Count)
            {
                data = new double[aiTask.SamplesToAcquire, aiTask.Channels.Count];
            }
        ...
        internal class Trigger
        {
            ...
            private AIDigitalTriggerSource _trigDigSrc = AIDigitalTriggerSource.TRGIN;
